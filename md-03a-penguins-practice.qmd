...
# 344 rows/ observations
# species = categorical, island = categorical, bill length = numerical, bill depth = numerical, flipper length = numerical, body mass = numerical, sex = categorical, year = categorical
```
